(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.btn-play').click(function () {
            ...
            $videoSrc = $(this).data("message");
            //document.write('Coming Soon With Introductory Video! Thanks For Clicking!')
        });
...
const mainImg = document.querySelector(".main-img-1");
const img = document.getElementsByClassName("demon");
function getImg(ele){
...
// save form data to file using js

 let saveFile = () => {
            // Get the data from each element on the form.
            const name = document.getElementById("name");
            const age = document.getElementById("email");
